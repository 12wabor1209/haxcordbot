...
module.exports.run = async (client, message) => {
  ...
  const botMsg = await message.reply('Hesaplýyorum. Bu iþlem biraz uzun sürebilir...?');
  const embed = new Discord.RichEmbed()
    .setTitle("Ýstatistiklerim")
    .addBlankField()
    .setColor("RANDOM")
    .addField("• Bellek Kullanýmým:", `[${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB](https://discordapp.com/oauth2/authorize?client_id=486140168839888907&scope=bot&permissions=8)`, true)
    .addField("• Çalýþma Sürem:", `[${duration}](https://discordapp.com/oauth2/authorize?client_id=486140168839888907&scope=bot&permissions=8)`, true)
    .addField("• Koruduðum", `[• Kullanýcýlar: ${client.users.size},\n• Sunucular: ${client.guilds.size},\n• Kanallar: ${client.channels.size}](https://discordapp.com/oauth2/authorize?client_id=486140168839888907&scope=bot&permissions=8)`, true)
...
module.exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['bot durum', 'i', 'bi', 'istatistikler', 'kullanýmlar', 'botdurum', 'bd', 'stats', 'stat'],
  permLevel: 0
};

module.exports.help = {
  name: 'istatistik',
  description: 'Botun Ýstatistiklerini Gösterir',
  usage: 'istatistik'
};